 ...
 * @return {string}
 */
Wasm2Lang.Backend.CsharpCodegen.prototype.emitFunction_ = function (
  wasmModule,
  binaryen,
  funcInfo,
  importedNames,
  ...
  var /** @const {string} */ visibility = isExported ? 'public ' : 'private ';
  ...
  var /** @const {string} */ returnType = Wasm2Lang.Backend.CsharpCodegen.csharpTypeName_(binaryen, funcInfo.results);
